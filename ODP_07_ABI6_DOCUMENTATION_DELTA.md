...
| §7, §21.2 | Amoy не используется (решение владельца 2026-09-24). Поколение развёрнуто в Polygon mainnet 2026-09-25 и утверждено; адреса в §7 и `chain/generations.json`. Бандлы ABI6 и ABI7 текущие исходники не описывают. |
