# Release-бандл ABI `0.7-redesign-8` — хеш утверждён владельцем 2026-09-24

**Утверждение 2026-09-24:** владелец утвердил canonical hash
`sha256:7392c8214e7f1258e3dc886ce89f5b5df30f65bca6d0ace2d1b7b3006ca414d7`. Любое изменение исходников даёт другой
хеш и требует нового бандла и нового утверждения. Целевая сеть — Polygon mainnet (137). Утверждение хеша само по себе
не выполняет deployment: кошелёк подключает и транзакции подписывает владелец. Ниже — исходная запись о сборке;
слова «кандидат» и «не утверждён» в ней относятся к моменту сборки.
